...
const footer = () => {
    ...
    <div class="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <div class="mt-8 flex justify-center space-x-6">
        <a href="https://www.facebook.com/SiJHez" class="text-gray-400 hover:text-gray-300">
        ...
        <a href="https://www.instagram.com/sinuhe.jh" class="text-gray-400 hover:text-gray-300">
        ...
        <a href="https://github.com/Sijhez" class="text-gray-400 hover:text-gray-300">
